        ...
        <div class="dashboard">
            ...
            <div class="dashboard-content">
                ...
                <div class="dashboard-title">
                    <h2>View Semester</h2>
                    <h3><a href="dashboard.php">Dashboard</a>/ <a href="addsemester.php">Add Semester</a>/ View Semester
                    </h3>
                </div>
                        ...
                        <table class="user-table">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['search']) && !empty($_GET['search'])) {
                                    ...
                                    $sql .= " WHERE CONCAT(id, class, faculty) LIKE '%$value%'";
                                }

                                $countSql = "SELECT COUNT(*) as total FROM semester";
                                if (isset($_GET['search']) && !empty($_GET['search'])) {
                                    $countSql .= " WHERE CONCAT(id, class, faculty) LIKE '%$value%'";
                                }
                                ...
                                if ($total > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($data)) {
                                        ...
                                        <td class='actionbtn'>
                                            <a href='editsemester.php?id=" . htmlspecialchars($row['id']) . "' class='btn update'>Update</a>
                                            <a href='deletesemester.php?id=" . htmlspecialchars($row['id']) . "' class='btn delete'>Delete</a>
                                        </td>
                                    </tr>";
                                    }
                                } else {
...
<script>
    $(document).ready(function () {
        ...
        $('.btn2').click(function (e) {
            ...
            if (id) {
                window.location.href = 'deletesemester.php?id=' + id;
            }
        });
    });
